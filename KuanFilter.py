...
class KuanFilter():
    ...
    def __init__(self):
        ...
        self.description = "Use Kuan filters to reduce speckle while preserving edges in radar images. It transforms the multiplicative noise model into an additive noise model. This filter is similar to the Lee filter but uses a different weighting function. The pixel being filtered is replaced with a value calculated based on the local statistics."
